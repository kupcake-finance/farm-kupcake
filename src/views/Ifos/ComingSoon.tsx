        ...
        <div>
          <Block>
            ...
            <Text mb={3}>
              {TranslateString(
                504,
                'You’ll pay for the new tokens using CAKE-KCS LP tokens, which means you need to stake equal amounts of CAKE and KCS in a liquidity pool to take part.',
              )}
            </Text>
            <Text mb={3}>
              <LiquidityLink href="https://exchange.pancakeswap.finance/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
                {TranslateString(506, 'Get CAKE-KCS LP >')}
              </LiquidityLink>
            </Text>
            <Text mb={3}>
              {TranslateString(508, 'The project gets the KCS, PancakeSwap burns the CAKE.')}
              <br />
